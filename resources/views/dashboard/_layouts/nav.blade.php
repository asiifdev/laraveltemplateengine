                ...
                <div class="scroll">
                    <ul class="list-unstyled border-last-none">
                        <li class="mb-3 pb-3 border-bottom border-separator-light d-flex">
                            <img src="{{ asset('dashboard/img/profile/profile-1.webp') }}"
                        ...
                        <li class="mb-3 pb-3 border-bottom border-separator-light d-flex">
                            <img src="{{ asset('dashboard/img/profile/profile-2.webp') }}"
                                class="me-3 sw-4 sh-4 rounded-xl align-self-center" alt="..." />
                            <div class="align-self-center">
                        ...
                        <li class="mb-3 pb-3 border-bottom border-separator-light d-flex">
                            <img src="{{ asset('dashboard/img/profile/profile-3.webp') }}"
                                class="me-3 sw-4 sh-4 rounded-xl align-self-center" alt="..." />
                            <div class="align-self-center">
                        ...
                        <li class="pb-3 pb-3 border-bottom border-separator-light d-flex">
                            <img src="{{ asset('dashboard/img/profile/profile-6.webp') }}"
                                class="me-3 sw-4 sh-4 rounded-xl align-self-center" alt="..." />
                            <div class="align-self-center">
